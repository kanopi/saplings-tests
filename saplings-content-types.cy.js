...
describe('Verify the Saplings Content Types recipe applied properly.', () => {
  ...
  it('Verify all the correct fields exists on paragraphs from saplings-component-types recipe.', () => {
    ...
    cy.get('#sa_width').should('exist')
    cy.get('#sa_width').find('.item-list').should('include.text', 'List (text)')
    cy.get('#sa_margin').should('exist')
    cy.get('#sa_margin').find('.item-list').should('include.text', 'List (text)')
    cy.get('#sa_padding').should('exist')
    cy.get('#sa_padding').find('.item-list').should('include.text', 'List (text)')
    cy.get('#sa_col').should('exist')
    cy.get('#sa_col').find('.item-list').should('include.text', 'List (text)')
    ...
    cy.get('#sa-header').should('exist')
    cy.get('#sa-header').find('.item-list').should('include.text', 'Text (plain)')
    cy.get('#sa_background').should('exist')
    cy.get('#sa_background').find('.item-list').should('include.text', 'List (text)')
    cy.get('#sa_width').should('exist')
    cy.get('#sa_width').find('.item-list').should('include.text', 'List (text)')
    cy.get('#sa_margin').should('exist')
    cy.get('#sa_margin').find('.item-list').should('include.text', 'List (text)')
